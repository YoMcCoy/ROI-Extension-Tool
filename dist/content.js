(function () {
    ...
    function getDividendFrequency$1(dividends) {
    ...
    function calculateAllRows(table, optionData, dividendData, profile) {
        ...
        const annualizedDividend = getAnnualizedDividend$1(dividendData);
